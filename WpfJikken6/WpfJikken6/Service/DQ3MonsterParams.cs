    ...
    public class DQ3MonsterParams : IReadOnlyList<GridInfoModel>
    {
        ...
        public static DQ3MonsterParams CreateGridData()
        {
            var list = new List<GridInfo> {
                new GridInfo(17) { Address = "3308", Caption = "Lv" },
                new GridInfo(17) { Address = "3309", Caption = "Exp", Size = 2 },
                new GridInfo(17) { Address = "330B", Caption = "素早さ" },
                new GridInfo(17) { Address = "330C", Caption = "Gold", Index = 2 },
                new GridInfo(17) { Address = "330D", Caption = "攻撃力" },
                new GridInfo(17) { Address = "330E", Caption = "守備力" },
                new GridInfo(17) { Address = "330F", Caption = "HP" },
                new GridInfo(17) { Address = "3310", Caption = "MP" },
                new GridInfo(17) { Address = "3311", Caption = "Drop", Filter = "01111111", Master = "Item" },
                new GridInfo(17) { Address = "3312", Caption = "行動1", Filter = "01111111", Master = "MonsterAction" },
                new GridInfo(17) { Address = "3313", Caption = "行動2", Filter = "01111111", Master = "MonsterAction" },
                new GridInfo(17) { Address = "3314", Caption = "行動3", Filter = "01111111", Master = "MonsterAction" },
                new GridInfo(17) { Address = "3315", Caption = "行動4", Filter = "01111111", Master = "MonsterAction" },
                new GridInfo(17) { Address = "3316", Caption = "行動5", Filter = "01111111", Master = "MonsterAction" },
                ...
                new GridInfo(17) { Address = "331A", Caption = "ﾊﾞｷﾞ系", Filter = "00001100", Master = "100%|70%|30%|0%" },
